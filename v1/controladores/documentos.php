...
class documentos
{
    ...
    const ID_DOCUEMNTO = "idDocumentos";
    const ID_EVENTO = "idEvento";
    const ID_TIPODOCUEMNTO = "idTipoDocumentos";
    const NOMBRE = "nombre";
    const RUTA = "ruta";
    const DOCUMENTO = "documentos";
    const CODIGO_VALIDACION = "codigoValidadcion";
...
//api.people.com/v1/documentos/idEvento/idDocumento -******-
    public static function get($peticion)
    {
        ...
        if (empty($peticion[1])) //si se envío idDoc
            return self::obtenerDocumentos($peticion[0]);
        else
    ...
    private function actualizar($idUsuario, $documento, $iddocumento)
    {
        try {
            ...
            $primerApellido = $documentoo->primerApellido;
